package org.subtlelib.poiooxml.impl.row;
...
import org.subtlelib.poiooxml.api.style.StyleRegistry;
import org.subtlelib.poiooxml.api.totals.ColumnTotalsDataRange;
import org.subtlelib.poiooxml.api.totals.Formula;
import org.subtlelib.poiooxml.impl.column.Columns;
import org.subtlelib.poiooxml.impl.style.StylesInternal;
import org.subtlelib.poiooxml.impl.style.system.SystemCellWrapTextStyle;
...
public class RowContextImpl extends AbstractDelegatingRowContext {
    ...
    private RowContext writeText(String text, Style style) {
    	...
    	createCell(1, style).setCellValue(new XSSFRichTextString(text));
    	return this;
    }
    ...
    private RowContext writeMultilineText(Collection<String> lines, Style style) {
		...
		createCell(lines.size(), styleWithWrapped).setCellValue(new XSSFRichTextString(text));
    	return this;
    }
